...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'Reconocimiento', icon: FiTrendingUp, path: '/reconocimiento'},
  { name: 'Historial', icon: FiCompass },
  { name: 'Mis clases', icon: FiSettings },
  { name: 'Mis alumnos', icon: FiSettings, path: '/alumnos' },
  { name: 'Comentarios', icon: FiSettings, path: '/comentarios' },
